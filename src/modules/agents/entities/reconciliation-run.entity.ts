...
export class ReconciliationRun {
  ...
  /**
   * Exception lane for convergence policy
   * - normal: Standard 14-day convergence window
   * - hotfix-exception: Expedited 3-day window
   * - spike-exception: Research 7-day window
   */
  @Column({ type: 'varchar', length: 30, default: 'normal' })
  exceptionLane: ExceptionLane;

  /**
   * Attestation type: local (advisory) or ci-attested (canonical)
